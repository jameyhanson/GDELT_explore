...
-- using SOURCEURL from PiggyBank
-- see https://cwiki.apache.org/confluence/display/PIG/PiggyBank
...
STORE hosts_with_lots_of_very_negative_by_week INTO '$RESULTS_BASE_DIR/results/hosts_with_lots_of_very_negative/01Mon_results';
